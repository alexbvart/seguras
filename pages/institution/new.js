                            ...
                            <Row className="" xs={1} sm={3}>
                                <Form.Group className="mb-3 " controlId="formBasicEmail" as={Col}>
                                    ...
                                    <Form.Text className="text-muted">
                                        ...
                                        {errors.nombre?.type === 'required' && <span className="text-danger">El nombre de la institución es obligatorio</span>}
                                        {errors.nombre?.type === 'maxLength' && <span className="text-danger">El nombre de la institución es obligatorio debe contener mas de 10 caracteres.</span>}
                                    </Form.Text>
                                </Form.Group>
                                <Form.Group className="mb-3 " controlId="formBasicEmail" as={Col}>
